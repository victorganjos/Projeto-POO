...
public class AtualizaUsuario extends javax.swing.JFrame {
    ...
    private void load() {
        List<Usuario> lista = UsuarioController.consultarPorId(id);
 
        for (Usuario li : lista) {
            txt_Nome.setText(li.getNome());
            txt_Username.setText(li.getUsername());
            txt_Senha.setText(li.getSenha());
        }
    }
    private void btn_SalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SalvarActionPerformed
        ...
        if (nome.equals("") || username.equals("") || senha.equals("")) {
            ...
            control.atualizar(id,nome, username, senha);
            JOptionPane.showMessageDialog(null, "Operação realizada com sucesso!");
            HomePage home = new HomePage();
            home.setVisible(true);
            AtualizaUsuario.this.dispose();
        }
