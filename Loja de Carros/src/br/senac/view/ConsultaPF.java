 ...
 */
public class ConsultaPF  extends javax.swing.JFrame implements Table {
    ...
    public void loadTable() {
        ArrayList<String[]> linhasClientes = PessoaFisicaController.consulta();
        ...
        tbl_ConsultaPF.setModel(tmClientes);
        for (String[] c : linhasClientes) {
            tmClientes.addRow(c);
        }
        tbl_ConsultaPF.getColumnModel().getColumn(0).setPreferredWidth(50);
        tbl_ConsultaPF.getColumnModel().getColumn(1).setPreferredWidth(150);
        tbl_ConsultaPF.getColumnModel().getColumn(2).setPreferredWidth(150);
        tbl_ConsultaPF.getColumnModel().getColumn(3).setPreferredWidth(50);
        tbl_ConsultaPF.getColumnModel().getColumn(4).setPreferredWidth(50);
    }

    public void pesquisar() {
        ArrayList<String[]> linhasClientes = PessoaFisicaController.consultaPorNome(txt_Nome.getText());
    ...
    private void initComponents() {
        ...
        scp_ConsultaPF = new javax.swing.JScrollPane();
        tbl_ConsultaPF = new javax.swing.JTable();
        ...
        tbl_ConsultaPF.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbl_ConsultaPF.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_ConsultaPFMouseClicked(evt);
            }
        });
        scp_ConsultaPF.setViewportView(tbl_ConsultaPF);
        ...
        pnl_ConsultaPFLayout.setVerticalGroup(
            ...
            .addGroup(pnl_ConsultaPFLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(scp_ConsultaPF, javax.swing.GroupLayout.PREFERRED_SIZE, 302, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tbl_ConsultaPFMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_ConsultaPFMouseClicked
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_tbl_ConsultaPFMouseClicked

    private void btn_AtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_AtualizarActionPerformed
        // TODO add your handling code here:
        if (tbl_ConsultaPF.getSelectedRow() != -1) {
            //  List<PessoaFisica> linhasClientes = PessoaFisicaController.consultarPorId((int) tbl_ConsultaPF.getValueAt(tbl_ConsultaPF.getSelectedRow(), 0));
            AtualizaPF atualiza = new AtualizaPF(Integer.parseInt((String) tbl_ConsultaPF.getValueAt(tbl_ConsultaPF.getSelectedRow(), 0)));
            atualiza.setVisible(true);
            ConsultaPF.this.dispose();
    ...
    private void btn_ExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ExcluirActionPerformed
        ...
        if (tbl_ConsultaPF.getSelectedRow() != -1) {
            ...
            PessoaFisicaController.excluir(Integer.parseInt((String) tbl_ConsultaPF.getValueAt(tbl_ConsultaPF.getSelectedRow(), 0)));
            loadTable();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaPF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaPF().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JScrollPane scp_ConsultaPF;
    private javax.swing.JTable tbl_ConsultaPF;
